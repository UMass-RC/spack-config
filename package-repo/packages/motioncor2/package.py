...
class Motioncor2(Package):
    ...
    version("1.4.5", sha256="e3687efcaaddb977713410942ac4509011ff6eccef092d2446ce71e65b4a545d")
    ...
    depends_on("cuda@10.2,11.3", type="run")
#    depends_on("cuda@10.2,11.1:11.5", type="run")
    ...
    def install(self, spec, prefix):
        ...
        #with working_dir("MotionCor2_{0}".format(spec.version)):
             os.system('pwd > /tmp/motioncor2.log')
             os.system('ls >> /tmp/motioncor2.log')
             install(
                     "MotionCor2_{0}_Cuda{1}-*".format(spec.version, cuda_version),
